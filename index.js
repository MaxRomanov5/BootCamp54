...
//Відрефакторити функцію,щоб вона приймала обєкт.Та задай параметрам занчення за замовчуваннями: імені 'Anonim',оцінка по 0
...
//     const {
//       name = "Anonim",
//       grades: { math = 0, geography = 0, physics = 0 },
//     } = student;
//     this.students.push({ name, grades: { math, geography, physics } });
//   },
// };
